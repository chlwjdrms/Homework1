...
// Class DownArrow
class DownArrow : public Geometric {
public:
	int start_x, start_y;
	int end_x, end_y;
	double xpos, ypos;
...
public:
	...
	DownArrow(const int& _start_x, const int& _start_y, const int& _end_x, const int& _end_y, double _xpos, double _ypos) {
	...
	void draw() {
		drawCircleInDownArrow(start_x, start_y, end_x, end_y, 1.0f, 0.0f, 0.0f, xpos, ypos);
	}
